      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-4 flex items-center justify-between h-16">
          ...
          <a href={CTA_LINK} target="_blank" rel="noopener noreferrer" className="hidden md:block">
            <button className="bg-primary text-primary-foreground font-heading text-sm px-6 py-2 rounded-lg cta-pulse hover:shadow-[0_0_25px_hsl(347_78%_55%/0.7)] transition-shadow">
              Quero Começar
            </button>
          </a>
            ...
            <ScrollReveal>
              <div>
                ...
                <h1 className="font-heading text-5xl md:text-7xl leading-tight text-foreground mb-6">
                  <TypewriterText
                    text="O método definitivo para qualquer mulher reduzir até 12cm de cintura, tratar a diástase e acabar com os escapes de urina em 12 semanas de treinos curtos em casa"
                    speed={25}
                    delay={300}
                  />
                </h1>
