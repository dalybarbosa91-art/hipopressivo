    ...
    <div className="min-h-screen bg-background text-foreground font-body">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="container mx-auto px-4 flex items-center justify-between h-16">
          <a href="#">
            <img src={logoImg} alt="Daly Barbosa - Treinamento Feminino" className="h-10 mix-blend-screen" />
          </a>
          ...
          <a href={CTA_LINK} target="_blank" rel="noopener noreferrer" className="hidden md:block">
            <button className="bg-primary text-primary-foreground font-heading px-6 py-2 rounded-lg cta-pulse hover:shadow-[0_0_25px_hsl(347_78%_55%/0.7)] transition-shadow text-base">
              Quero Começar
            </button>
          </a>
            ...
            <ScrollReveal>
              <div>
                ...
                <h1 className="font-heading text-5xl md:text-7xl leading-tight text-foreground mb-6">
                  <TypewriterText
                    text="Reduza até 12cm de cintura, trate a diástase e acabe com os escapes de urina em 12 semanas de treinos curtos em casa"
                    className="text-6xl"
                    speed={25}
                    delay={300}
                  />
